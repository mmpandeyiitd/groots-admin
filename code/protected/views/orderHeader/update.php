...
<!--<p class="note">Fields with <span class="required">*</span> are required.</p>-->
   ...
   <div class="span4">
                        ...
                        <div class="span4 pull-right">
                            ...
                            <label>Name:</label>
                            <span class="detail">
                                <div id="old_shipping_name" style="<?php if(empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;"><?php echo $modelOrder->attributes['shipping_name']; ?></div>
                                <input type="text" id="shipping_name" name="shipping_name" style="<?php if(!empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;margin-top:7px;" value="<?php echo $modelOrder->attributes['shipping_name']; ?>"/>
                            </span>
                            <div class="clearfix"></div>
                            <label>Address:</label> <span class="detail">
                                <div id="old_shipping_address" style="<?php if(empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;"><?php echo $modelOrder->attributes['shipping_address']; ?></div>
                                <input type="text" id="shipping_address" name="shipping_address" style="<?php if(!empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;margin-top:7px;" value="<?php echo $modelOrder->attributes['shipping_address']; ?>"/>
                            </span>
                            <div class="clearfix"></div>
                            <label>City:</label> 
                            <span class="detail">
                                <div id="old_shipping_city" style="<?php if(empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;"><?php echo $modelOrder->attributes['shipping_city']; ?></div>
                                <input type="text" id="shipping_city" name="shipping_city" style="<?php if(!empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;margin-top:7px;" value="<?php echo $modelOrder->attributes['shipping_city']; ?>"/>
                            </span>
                            <div class="clearfix"></div> 
                            <label>State:</label>
                            <span class="detail">
                                <div id="old_shipping_state" style="<?php if(empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;"><?php echo $modelOrder->attributes['shipping_state']; ?></div>
                                <input type="text" id="shipping_state" name="shipping_state" style="<?php if(!empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;margin-top:7px;" value="<?php echo $modelOrder->attributes['shipping_state']; ?>"/></span>
                            <div class="clearfix"></div> 
                            <label>Pincode</label> 
                            <span class="detail">
                                <div id="old_shipping_pincode" style="<?php if(empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;"> <?php echo $modelOrder->attributes['shipping_pincode']; ?></div>
                                <input type="text" id="shipping_pincode" name="shipping_pincode" style="<?php if(!empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;margin-top:7px;" value="<?php echo $modelOrder->attributes['shipping_pincode']; ?>"/></span>
                            <div class="clearfix"></div> 
                            <label>Country:</label> <span class="detail">India</span>
                            <div class="clearfix"></div>
                            <label>Mobile:</label> <span class="detail">
                                <div id="old_shipping_phone" style="<?php if(empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;"><?php echo $modelOrder->attributes['shipping_phone']; ?></div>
                                <input type="text" id="shipping_phone" name="shipping_phone" style="<?php if(!empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;margin-top:7px;" value="<?php echo $modelOrder->attributes['shipping_phone']; ?>"/></span>
                            <input type="submit" class="activebutton" id="update_shipping_address" name="update_shipping_address" style="<?php if(!empty($form->errorSummary($modelOrder))){ echo 'display: inline';}else{ echo 'display: none';}?>;margin-right: 200px; margin-top: 5px;" value="Update"/>
                            <div class="clearfix"></div>  
                        </div>
                                        ...
                                        if(is_numeric($base_product_ids_array[0]))
                                         {
                                          ...
                                          if(!empty($image_product)){ echo '<img src="'.$image_product.'">';}else{ echo '<img src="http://yorder.canbrand.in/images/product_04.jpg">';}?>
                                       </a>
                                </div>
                            </div>
    ...
    <?php //echo $infodetail[0]['seller_name']; ?> <span>Unit Price <i class="fa fa-inr"></i> <?php if (isset($unit_prices_array[0])) echo $unit_prices_array[0]; ?></span>
                               ...
                               <div class="order_sizecontain">
                                    <?php  $no_baseproducts=count($base_product_ids_array);
