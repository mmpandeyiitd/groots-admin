...
<div class="portlet-content">
  <?php $this->renderPartial('form', array('model' => $model, 'record' => $record, 'imageinfo' => $imageinfo,'a'=>$a,'new_data'=>$new_data,'qunt'=>$qunt,'Weight' => $Weight,'WeightUnit' => $WeightUnit,'Length' => $Length,'LengthUnit' => $LengthUnit,'inv_header' => $inv_header)); ?>
    </div>
</div>
