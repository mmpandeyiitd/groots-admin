...
<?php $this->renderPartial('_purchaseForm', array('model'=>$model, 'inv_header'=>$inv_header, 'dataProvider'=>$dataProvider, 'w_id'=>$w_id, 'purchaseLineMap'=>$purchaseLineMap, 'priceMap' => $priceMap)); ?>
