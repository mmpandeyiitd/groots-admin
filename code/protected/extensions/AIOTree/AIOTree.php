<?php
    class AIOTree extends CWidget
    {
        ...
        public $label_collapse='Collapse All';
        public $label_expand='Expand All';
        ...
        public function echo_li($id){
            ...
            else if($this->type=='radio' || $this->type=='checkbox')
            {
                ...
                $this->display_html_attr($this->liListStyle,'style');
                $this->display_html_attr($this->liHtmlOptions);
                if(!empty($this->data[$id]['checked'])){
                	echo ' checked="checked" ';
                }
                echo '>';            
                $cat_id = explode('---', $id);
                echo $this->data[$id]['text']."({$cat_id['1']})";
				//echo $this->data[$id]['text']."({$cat_id['1']})";
            }
        }
        ...
        public function aiotreecontrol(){
            if($this->controlShow==true){
                ...
                echo isset($this->controlLabel['Collapse'])?"Collapse All":$this->label_collapse;
                echo '</a>';
                echo $this->controlDivider;
                echo '<a href="?#" id="aiotree_expand" class="aiotree_expand">';
                                echo isset($this->controlLabel['expand'])?"Expand All":$this->label_expand;
                echo '</a>';
