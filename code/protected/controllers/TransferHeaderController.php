	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','admin', 'dailyTransfer'),
				'users'=>array('@'),
			),
...
//print_r($_POST);die;
        ...
        if($w_id==SOURCE_WH_ID) {
            ...
            foreach ($warehouses as $warehouse){
                if($warehouse->id != $w_id && $w_id != HD_OFFICE_WH_ID){
                    $this->updateDailyTransferOrder($warehouse->id, $date);
                }
            }
    ...
    public function updateDailyTransferOrder($w_id, $date){
        ...
        if($w_id==SOURCE_WH_ID){
            ...
            $this->createTransferOrder($transferOrderMap, $date, $w_id);
        }


    }

    private function createTransferOrder($transferOrderMap, $date, $w_id){
